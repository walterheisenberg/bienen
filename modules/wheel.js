...
function drawWheel() {
    ...
    // );
    //
    // gradient.addColorStop(0.0, "#b2fef7");  // helles Petrol-Mittel
    // gradient.addColorStop(0.6, "#008080");  // echtes Petrol
    // gradient.addColorStop(1.0, "#005f5f");  // dunkler Rand
    ...
    // );
    //
    // gradient.addColorStop(0.0, "#66b2b2"); // hell
    // gradient.addColorStop(0.7, "#007b7b"); // mittel
    // gradient.addColorStop(1.0, "#004d4d"); // dunkel

    // Monochromatischer Blauton-Verlauf
    const gradient = ctx.createRadialGradient(
        WHEEL_CONFIG.center,
        WHEEL_CONFIG.center,
        0,
    ...
    gradient.addColorStop(0.0, "#a3c8ff");  // helles Blau (Mittelpunkt)
    gradient.addColorStop(0.7, "#007bff");  // Button-Blau
    gradient.addColorStop(1.0, "#0056b3");  // dunkler Rand
