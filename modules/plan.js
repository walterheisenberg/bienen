...
window.schedules = {
    Zucht: [
        ...
        { offset: 38, task: 'Begattungskontrolle, Abh. Belegstelle', selectable: false, additionalText: 'Die Begattung wird kontrolliert. Die Begattungskästchen werden von der Belegstelle geholt.' }
    ],
    ...
    Drohnen: [
        { offset: 0, task: 'Eiablage', selectable: true, additionalText: 'Die Königin bestiftet das vorbereitete Baurähmchen.' },
        { offset: 8, task: 'Drohnenvolk füttern', selectable: true, additionalText: 'Starke Fütterung des Drohnenvolkes mit eiweißreichem Futter (Pollenersatz) beginnen, um optimale Pflegebedingungen zu sichern' },
        { offset: 18, task: 'Drohnenvolk schieden oder verstärken', selectable: false, additionalText: 'Das Drohnenvolk schiedet oder verstärkt man mit schlüpfender Brut, um ein Auskühlen des Brutnestes zu verhindern. Die Drohnen sind nun robust' },
        { offset: 24, task: 'Schlupf der Drohnen', selectable: true, additionalText: 'Schlupf der Drohnen. Die Waben werden idealerweise in einen Flugkäfig oder ein weiselloses Pflegevolk umgehängt' },
        { offset: 25, task: 'kleine Fütterungen Anf.', selectable: true, additionalText: 'Tägliche, kleine Flüssigfütterung, um die Pflegebienen und Drohnen optimal zu versorgen. Tägliche Ausflüge zum Abkoten ermöglichen' },
        { offset: 39, task: 'kleine Fütterungen Ende', selectable: true, additionalText: 'Tägliche, kleine Flüssigfütterung beenden' },
        { offset: 40, task: 'Geschlechtsreife', selectable: true, additionalText: 'Die Drohnen sind nun bereit für die Spermagewinnung' }
    ]
};
